...
from fixit.common import full_repo_metadata as frm
...
class FullRepoMetadataTest(UnitTest):
    ...
    def test_get_repo_caches_single_path(self, gen_cache: MagicMock) -> None:
        ...
        repo_caches = get_repo_caches((self.DUMMY_PATH,), FullRepoMetadataConfig({TypeInferenceProvider}, 1))
    ...
    def test_get_repo_caches_swallows_exception(self, gen_cache: MagicMock) -> None:
        ...
        assert repo_caches == {self.DUMMY_PATH: {TypeInferenceProvider: {"types": []}}}
    ...
    def test_get_repo_caches_honors_batch_size(self, gen_cache: MagicMock) -> None:
        ...
        get_repo_caches(paths, FullRepoMetadataConfig({TypeInferenceProvider}, 1, batch_size=2))
    ...
    def test_get_repo_caches_with_logger(self, gen_cache: MagicMock) -> None:
        ...
        get_repo_caches(
            [self.DUMMY_PATH],
            FullRepoMetadataConfig({TypeInferenceProvider}, 1, batch_size=2, logger=logger),
        )
