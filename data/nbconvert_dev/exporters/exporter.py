...
class Exporter(LoggingConfigurable):
    ...
    default_preprocessors = List([
                                  'nbconvert_dev.preprocessors.TagRemovePreprocessor',
                                  'nbconvert_dev.preprocessors.RegexRemovePreprocessor',
                                  'nbconvert_dev.preprocessors.ClearOutputPreprocessor',
                                  'nbconvert_dev.preprocessors.ExecutePreprocessor',
                                  'nbconvert_dev.preprocessors.coalesce_streams',
                                  'nbconvert_dev.preprocessors.SVG2PDFPreprocessor',
                                  'nbconvert_dev.preprocessors.CSSHTMLHeaderPreprocessor',
                                  'nbconvert_dev.preprocessors.LatexPreprocessor',
                                  'nbconvert_dev.preprocessors.HighlightMagicsPreprocessor',
                                  'nbconvert_dev.preprocessors.ExtractOutputPreprocessor',
                              ],
    ...
    def register_preprocessor(self, preprocessor, enabled=False):
        ...
        Parameters
        ----------
        preprocessor : :class:`~nbconvert_dev.preprocessors.Preprocessor`
