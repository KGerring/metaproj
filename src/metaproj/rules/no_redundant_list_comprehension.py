...
UNNECESSARY_LIST_COMPREHENSION: str = "Unnecessary list comprehension - {func} can take a generator, and is likely " + "to short-circuit, so constructing a list is probably wasteful."
...
class NoRedundantListComprehensionRule(CstLintRule):
    ...
    def visit_Call(self, node: cst.Call) -> None:
        ...
        if m.matches(
            ...
            self.report(
                node,
                UNNECESSARY_LIST_COMPREHENSION.format(func=cst.ensure_type(node.func, cst.Name).value),
