...
class CollapseIsinstanceChecksRule(CstLintRule):
    ...
    MESSAGE: str = "Multiple isinstance calls with the same target but " + "different types can be collapsed into a single call " + "with a tuple of types."
    ...
    INVALID = [
        ...
        Invalid(
            ...
            expected_replacement=("isinstance(x, (a, b)) or isinstance(y, (c, d)) or isinstance(z, e)" + " or isinstance(q, (f, g, h))"),
        ),
    ]
    ...
    def visit_BooleanOperation(self, node: cst.BooleanOperation) -> None:
        ...
        for operand in operands:
            ...
            if replacement is None:
                ...
                replacement = cst.BooleanOperation(left=replacement, right=operand, operator=cst.Or())
