        ...
        if m.matches(
            ...
            new_call = node.with_changes(
                ...
                args=[
                    ...
                    cst.Arg(ensure_type(node.args[0].value, cst.Comparison).comparisons[0].comparator),
                ],
            )
            ...
            if m.matches(
                ...
                arg2 = cst.Arg(ensure_type(node.args[0].value, cst.Comparison).comparisons[0].comparator)
            elif m.matches(
                node,
                m.Call(
