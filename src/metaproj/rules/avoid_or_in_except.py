...
class AvoidOrInExceptRule(CstLintRule):
    ...
    MESSAGE: str = "Avoid using 'or' in an except block. For example:" + "'except ValueError or TypeError' only catches 'ValueError'. Instead, use " + "parentheses, 'except (ValueError, TypeError)'"
    VALID = [
        Valid(
            """
            try:
